...
public class TestSimplexNoise {  // Simplex noise in 2D, 3D and 4D
    Random r;
    int lowerLevel;
    int reliefAmplitude;
    int res;
  ...
  138,236,205,93,222,114,67,29,24,72,243,141,128,195,78,66,215,61,156,180};
    ...
    public TestSimplexNoise(int lowerReliefLevel, int reliefAmplitude, int resolution, int seed) {
        this.lowerLevel = lowerReliefLevel;
        ...
        if(seed!=0)
            ...
            this.r = new Random();
        ArrayList ls = new ArrayList<Short>();
    ...
    public TestSimplexNoise(int lowerReliefLevel, int reliefAmplitude, int resolution){
        this(lowerReliefLevel, reliefAmplitude, resolution, 0);
    }
  ...
  // 2D simplex noise
  public int noise(double xin, double yin) {
    xin/=res;
    yin/=res;
    ...
    return (int)((70.0 * (n0 + n1 + n2))*(reliefAmplitude/1.42)+(reliefAmplitude/2)+(lowerLevel));
  }
